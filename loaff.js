...
back.addEventListener('click', ()=>{
    ...
    song_title.forEach(ele =>{
     ...
     makeAllPlays()
    document.getElementById(`audio/audio ${index}`).classList.remove('bi playListPlay bi-play-fill');
    document.getElementById(`audio/audio ${index}`).classList.add('bi-pause-fill');
    makeAllBackgrounds();
    Array.from(document.getElementsByClassName('song_item'))[`${index-18}`].style.background = "rgb(105, 105, 170, .1)";
})
